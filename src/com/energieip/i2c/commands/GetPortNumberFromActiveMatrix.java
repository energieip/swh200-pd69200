...
public class GetPortNumberFromActiveMatrix {
	...
	public static void main(String[] args) {
		if (args.length == 2) {
			...
			System.err.println("Usage: [Command] i2Cbus channel");
			System.exit(1);
		}
	}
	...
	private static void command(String[] args) {
		try {
			...
			System.out.println(pd69200.pse_get_port_number_from_active_matrix(secondArg));
